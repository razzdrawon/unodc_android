...
public class SyncWS {
    ...
    public static void makePostObjSyncRequest(final String url, JSONObject buzonParams, final RequestListener listener)  {

        JsonObjectRequest jsonObjReq = new JsonObjectRequest(Request.Method.POST, url, buzonParams,
